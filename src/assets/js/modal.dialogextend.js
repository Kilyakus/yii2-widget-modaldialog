(function() {
  ...
  $.widget("mi.dialogExtend", {
    ...
    _initButtons: function() {
      ...
      buttonPane.append('<a class="ui-dialog-titlebar-restore ui-corner-all ui-state-default" href="#"><span class="fa ' + this.options.icons.restore + '" title="restore"></span></a>').find('.ui-dialog-titlebar-restore').attr("role", "button").mouseover(function() {
    ...
    _initModuleButton: function(name, mode) {
      ...
      return buttonPane.append('<a class="ui-dialog-titlebar-' + name + ' ui-corner-all ui-state-default" href="#" title="' + name + '"><span class="fa ' + this.options.icons[name] + '"></span></a>').find(".ui-dialog-titlebar-" + name).attr("role", "button").mouseover(function() {
        return $(this).addClass("ui-state-hover");
      }).mouseout(function() {
        return $(this).removeClass("ui-state-hover");
      }).focus(function() {
